...
import com.example.gestioncommerciale.retrofit.ApiInterface;
import com.example.gestioncommerciale.retrofit.RetrofitService;
        ...
        btnRegister.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (validateUserName() && validatePassword()) {
                    User user = new User(etRegisterUsername.getText().toString(),etRegisterEmail.getText().toString(), etRegisterPassword.getText().toString());
